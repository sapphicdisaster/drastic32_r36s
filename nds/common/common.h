...
#elif defined(R36S)
#define DEF_STATE_PATH      "/opt/drastic"
#define DEF_JOY_MODE        JOYSTICK_MODE_DIGITAL
#define DEF_RJOY_MODE       JOYSTICK_MODE_TOUCH
#define DEF_JOY_DZONE       500
#define DEF_RJOY_DZONE      500
#define DEF_SWIN_POS        3
